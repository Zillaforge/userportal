...
export default {
  name: 'DataExchangeContentListView',
};
</script>
...
const {
  ...
  resetValue,
} = useCloudStorage(PAGE_TYPES.DATA_EXCHANGE_CONTENT_LIST);
...
const noDataSetting = computed(() =>
  getNoDataSetting(PAGE_TYPES.DATA_EXCHANGE_CONTENT_LIST)
);
...
<template>
  <ContentListComponent
    ...
    :enable-delete="isPublicSite()"
    :allocated-bytes="allocatedBytes"
    :used-bytes="usedBytes"
    :table-action-list="getTableActionList()"
